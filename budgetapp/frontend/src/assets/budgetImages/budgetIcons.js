...
export const budgetDashboard = <i class="fa-solid fa-table"></i>
export const budgetBudget = <i class="fa-solid fa-money-bill-transfer"></i>
export const budgetExpense = <i class="fa-solid fa-money-bill-trend-up"></i>
export const budgetIncome = <i class="fa-solid fa-hand-holding-dollar"></i>
export const budgetPackage = <i class="fa-solid fa-cubes"></i>
export const budgetAnaly = <i class="fa-solid fa-chart-simple"></i>
export const budgetSetting = <i class="fa-solid fa-gear"></i>
export const budgetLogout = <i class="fa-solid fa-right-from-bracket"></i>