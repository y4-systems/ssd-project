    ...
    <React.Fragment>
      {shippingData && Object.keys(shippingData).length > 0 ? (
        <React.Fragment>
          ...
          <StyledTypography variant="h6">
            Phone No: {shippingData && shippingData.phoneNo}
          </StyledTypography> */}
          ...
          <Table>
            <TableBody>
              <TableRow>
                ...
                <TableCell>{shippingData && shippingData.address}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>City</TableCell>
                <TableCell>{shippingData && shippingData.city}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>State</TableCell>
                <TableCell>{shippingData && shippingData.state}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>Country</TableCell>
                <TableCell>{shippingData && shippingData.country}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>Pin Code</TableCell>
                <TableCell>{shippingData && shippingData.pinCode}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>Phone No</TableCell>
                <TableCell>{shippingData && shippingData.phoneNo}</TableCell>
              </TableRow>
            </TableBody>
          </Table>
          {profile ? (
